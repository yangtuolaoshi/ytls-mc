...
@RegisterItem("thunder_cloud")
public class ThunderCloudItem extends Item {
    public ThunderCloudItem() {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        WeatherCloudEntity cloud = new WeatherCloudEntity(level, WeatherCloudEntity.CloudKind.THUNDER);
