...
public enum MilkType {
    COW("cow_milk", "ytls:cow_milk_bucket", 80, 40, 0),
    CHICKEN("chicken_milk", "ytls:chicken_milk_bucket", 160, 100, 0),
    CREEPER("creeper_milk", "ytls:creeper_milk_bucket", 100, 0, 0),
    ENDERMAN("enderman_milk", "ytls:enderman_milk_bucket", 100, 0, 20),
    VILLAGER("villager_milk", "ytls:villager_milk_bucket", 160, 100, 0),
    RABBIT("rabbit_milk", "ytls:rabbit_milk_bucket", 160, 100, 0),
    SHULKER("shulker_milk", "ytls:shulker_milk_bucket", 100, 60, 0),
    SPIDER("spider_milk", "ytls:spider_milk_bucket", 100, 80, 0),
    DRAGON("dragon_milk", "ytls:dragon_milk_bucket", 100, 0, 0),
    WITHER("wither_milk", "ytls:wither_milk_bucket", 100, 0, 0),
    PLAYER("player_milk", "ytls:player_milk_bucket", 100, 0, 0);
    ...
    MilkType(String id, String bucketItemId, int drinkDurationTicks, int fluidEffectDurationTicks, int rainCooldownTicks) {
        this.id = id;
